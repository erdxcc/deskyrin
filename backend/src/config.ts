...
export const config = {
  ...
  solanaProgramId:
    process.env.RECYCLING_PROGRAM_ID ?? "4mpEQjcASo912VDw8HtW89Ps44T4q8BaaVpYPRup4AQi",
  ...
  walletEncryptionSecret:
    process.env.WALLET_ENCRYPTION_SECRET ?? "dev-only-insecure-secret-min-32-chars!!",
